...
if environment == "okd":
    ...
    "pod_template_file": "/opt/airflow/pod_templates/okd/heavy_task_template.yaml"
}
elif environment == "openshift":
    executor_config_template = {
    "pod_template_file": "/opt/airflow/pod_templates/openshift/heavy_task_template.yaml"
}
