...
| [`wsc_hydrometric.py`](/airflow/etl_pipelines/scrapers/StationObservationPipeline/water/wsc_hydrometric.py) | [MSC Data Mart](https://eccc-msc.github.io/open-data/msc-datamart/readme_en/) | Hydrometric Data from MSC. | <ul><li>Discharge</li><li>Water Level</li></ul> |
