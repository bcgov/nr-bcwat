...
class StationObservationPipeline(EtlPipeline):
    ...
    def download_data(self):
        ...
        if (len(self.source_url.keys())-failed_downloads)/len(self.source_url.keys()) < self.min_ratio and "Quarterly" not in self.name:
    ...
    def clean_up(self):
        ...
        logger.info("Cleaning up the downloaded files")
