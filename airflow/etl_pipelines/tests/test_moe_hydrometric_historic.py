...
def test_get_all_source_urls(
    ...
    assert pipeline.source_url == {'Discharge.csv': 'https://www.env.gov.bc.ca/wsd/data_searches/water/Discharge.csv', 'Discharge_Archive_2015Oct_2017Oct.csv': 'https://www.env.gov.bc.ca/wsd/data_searches/water/Discharge_Archive_2015Oct_2017Oct.csv', 'Discharge_Archive_2017Oct_2019Oct.csv': 'https://www.env.gov.bc.ca/wsd/data_searches/water/Discharge_Archive_2017Oct_2019Oct.csv', 'Discharge_Archive_2019Oct_2021Oct.csv': 'https://www.env.gov.bc.ca/wsd/data_searches/water/Discharge_Archive_2019Oct_2021Oct.csv', 'Discharge_Archive_2021Oct_2023Oct.csv': 'https://www.env.gov.bc.ca/wsd/data_searches/water/Discharge_Archive_2021Oct_2023Oct.csv', 'Discharge_Archive_Post_20231001.csv': 'https://www.env.gov.bc.ca/wsd/data_searches/water/Discharge_Archive_Post_20231001.csv', 'Discharge_Archive_Pre_20151001.csv': 'https://www.env.gov.bc.ca/wsd/data_searches/water/Discharge_Archive_Pre_20151001.csv'}
