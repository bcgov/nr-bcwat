...
data_import_dict_from_s3 = {
    ...
    "station_region":{"tablename": "station_region", "schema": "bcwat_obs", "needs_join": True, "dtype": station_region_dtype},
    ...
    "licence_ogc_short_term_approval":{"tablename": "licence_ogc_short_term_approval", "schema": "bcwat_lic", "needs_join": False, "dtype": licence_ogc_short_term_approval_dtype},
    "licence_bc_purpose":{"tablename": "licence_bc_purpose", "schema": "bcwat_lic", "needs_join": False, "dtype": licence_bc_purpose_dtype},
    "bc_wls_wrl_wra":{"tablename": "bc_wls_wrl_wra", "schema": "bcwat_lic", "needs_join": False, "dtype": bc_wls_wrl_wra_dtype},
    "wls_water_approval_deanna":{"tablename": "wls_water_approval_deanna", "schema": "bcwat_lic", "needs_join": False, "dtype": wls_water_approval_deanna_dtype},
    "bc_wls_water_approval":{"tablename": "bc_wls_water_approval", "schema": "bcwat_lic", "needs_join": False, "dtype": bc_wls_water_approval_dtype},
    "water_management_district_area": {"tablename": "water_management_district_area", "schema": "bcwat_lic", "needs_join": False, "dtype": water_management_district_area_dtype},
    "licence_bc_app_land": {"tablename": "licence_bc_app_land", "schema": "bcwat_lic", "needs_join": False, "dtype": licence_bc_app_land_dtype},
    "bc_data_import_date": {"tablename": "bc_data_import_date", "schema": "bcwat_lic", "needs_join": False, "dtype": bc_data_import_date_dtype},
    "elevation_bookend":{"tablename": "elevation_bookend", "schema": "bcwat_lic", "needs_join": False, "dtype": elevation_bookend_dtype},
    "lake": {"tablename": "lake", "schema": "bcwat_ws", "needs_join": False, "dtype": lake_dtype},
    "lake_licence": {"tablename": "lake_licence", "schema": "bcwat_lic", "needs_join": False, "dtype": lake_licence_dtype},
    "fwa_fund":{"tablename": "fwa_fund", "schema": "bcwat_ws", "needs_join": False, "dtype": fwa_fund_dtype},
    "fwa_union":{"tablename": "fwa_union", "schema": "bcwat_ws", "needs_join": False, "dtype": fwa_union_dtype},
    "fund_rollup_report":{"tablename": "fund_rollup_report", "schema": "bcwat_ws", "needs_join": False, "dtype": fund_rollup_report_dtype},
    "fwa_stream_name":{"tablename": "fwa_stream_name", "schema": "bcwat_ws", "needs_join": False, "dtype": fwa_stream_name_dtype},
    "fwa_stream_name_unique":{"tablename": "fwa_stream_name_unique", "schema": "bcwat_ws", "needs_join": False, "dtype": fwa_stream_name_unique_dtype},
    "geo_feature":{"tablename": "geo_feature", "schema": "bcwat_ws", "needs_join": False, "dtype": geo_feature_dtype},
    "mapsearch2":{"tablename": "mapsearch2", "schema": "bcwat_ws", "needs_join": False, "dtype": mapsearch2_dtype},
    "ws_geom_all_report": {"tablename": "ws_geom_all_report", "schema": "bcwat_ws", "needs_join": False, "dtype": ws_geom_all_report_dtype},
