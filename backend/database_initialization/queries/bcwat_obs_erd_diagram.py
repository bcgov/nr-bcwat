bcwat_obs_query = '''
    ...
    ALTER TABLE "bcwat_obs"."water_quality_hourly" ADD CONSTRAINT "water_quality_hourly_unit_id_fkey" FOREIGN KEY ("parameter_id") REFERENCES "bcwat_obs"."water_quality_unit" ("unit_id");
