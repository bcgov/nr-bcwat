...
describe('<GroundWaterLevelReport />', () => {
    ...
    it('mounts and render report contents', () => {
        ...
        cy.get('.line.median').should('exist').and('be.visible').and('have.attr', 'stroke').and('eq', 'orange')
        ...
        cy.get('.q-table > tbody > .q-tr:nth-child(4) > .text-right:nth-child(6)').should('contain', '20.123');
    });
});
