...
describe('<HydrologicVariability />', () => {
    it('mounts and renders', () => {
        ...
        cy.get('#hydrologic-watershed-table > table > tbody > tr.query-row > td:nth-child(1) > table > tbody > tr:nth-child(1) > td:nth-child(2) > b').should('contain', 'Query Watershed');
        cy.get('#hydrologic-watershed-table > table > tbody > tr:nth-child(4) > td:nth-child(1) > table > tbody > tr:nth-child(3) > td:nth-child(2)').should('contain', 'Pinkut Creek Near Tintagel');
        // chart testing
