    ...
    >
        <div v-if="props.activePoint" class="report-sidebar">
            ...
            <q-list class="q-mt-sm">
                <q-item 
                    clickable 
                    :class="viewPage === 'groundWaterQuality' ? 'active' : ''"
                    @click="() => (viewPage = 'groundWaterQuality')"
                >
                    <div class="text-h6">Ground Water Quality</div>
                </q-item>
            </q-list>
            <div>
                <span class="about"
        ...
        <q-tab-panels v-model="viewPage">
            ...
            >
                ...
                <div  class="ground-water-quality-table">
                    <table>
                        <tbody>
                            ...
                            >
                                ...
                                <td>
                                    <div class="mini-chart">
                                        ...
                                        <GroundWaterQualityMiniChart 
                                            :selected-point="props.activePoint"
                                            :chart-data="param.data"
                                            :chart-id="`ground-quality-chart-mini-${param.paramId}`"
                                        />
                                    </div>
                                </td>
                                <td 
        ...
        <q-dialog v-model="showChart">
            ...
            >
                ...
                <GroundWaterQualityReportChart
                    v-if="props.activePoint"
                    :selected-point="props.activePoint"
                    :chart-data="selectedChartData"
                    :chart-id="`ground-quality-coliform-chart-${selectedChartData.paramId}`"
                />
            </q-card>
        </q-dialog>
    </div>
...
<script setup>
import GroundWaterQualityReportChart from '@/components/groundwater/GroundWaterQualityReportChart.vue';
import groundWaterChemistry from '@/constants/groundWaterChemistry.json';
import GroundWaterQualityMiniChart from '@/components/groundwater/GroundWaterQualityMiniChart.vue';
...
const viewPage = ref('groundWaterQuality');
...
const getData = async () => {
    // add API call
    chemistry.value = groundWaterChemistry;
}
