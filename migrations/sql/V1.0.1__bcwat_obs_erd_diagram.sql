...
CREATE TABLE "bcwat_obs"."station_observation" (
"station_id" bigint,
...
ALTER TABLE "bcwat_obs"."station_observation" ADD CONSTRAINT "water_discharge_station_id_fkey" FOREIGN KEY ("station_id") REFERENCES "bcwat_obs"."station" ("station_id");

ALTER TABLE "bcwat_obs"."station_observation" ADD CONSTRAINT "water_discharge_variable_id_fkey" FOREIGN KEY ("variable_id") REFERENCES "bcwat_obs"."variable" ("variable_id");

ALTER TABLE "bcwat_obs"."station_observation" ADD CONSTRAINT "water_discharge_qa_id_fkey" FOREIGN KEY ("qa_id") REFERENCES "bcwat_obs"."qa_type" ("qa_type_id");

ALTER TABLE "bcwat_obs"."station_observation" ADD CONSTRAINT "water_discharge_symbol_id_fkey" FOREIGN KEY ("symbol_id") REFERENCES "bcwat_obs".symbol("symbol_id");
